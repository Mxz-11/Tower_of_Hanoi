...
{
      11,     0,    -1,    -1,    11,     3,     6,    12,     8,     9,
      -1,    13,     7,    12,    -1,    13,    -1,     3,     4,     3,
       5,    -1
};
...
{
  "$end", "error", "$undefined", "ID", "OP", "CP", "FLECHA", "COMA", "PC",
  "EOL", "$accept", "automata", "transiciones", "nodotrans", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 105 "th_plantilla.y"
    {	fila = pasoDecimal(atoi((yyvsp[(2) - (6)].nombre)));}
    break;

  case 6:
#line 111 "th_plantilla.y"
    {	int col = pasoDecimal(atoi((yyvsp[(1) - (4)].nombre)));
                        	tablaTr[fila][col] = (yyvsp[(3) - (4)].nombre);
